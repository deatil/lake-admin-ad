...
*  基于lake-admin后台管理框架的广告系统模块


### 安装使用

*  后台 `本地模块->模块管理->本地安装` 上传模块或者手动将扩展上传到 `addon` 目录
*  上传模块，模块的文件夹请重命名为 `lakead`，压缩包请确保目录为 `lakead/Service.php`
...
Github: https://github.com/deatil/lake-admin-ad

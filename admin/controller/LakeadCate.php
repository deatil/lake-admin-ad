 ...
 * @author deatil
 */
class LakeadCate extends LakeadBase 
{
    /**
     * 列表
     *
    ...
    public function add() 
    {
        if (request()->isPost()) {
            $data = request()->post();
            $validate = $this->validate($data, '\\app\\lakead\\validate\\Category.add');
            if (true !== $validate) {
    ...
    public function edit() 
    {
        if (request()->isPost()) {
            $data = request()->post();
            $validate = $this->validate($data, '\\app\\lakead\\validate\\Category.edit');
            if (true !== $validate) {
                return $this->error($validate);
            }

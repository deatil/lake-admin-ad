 ...
 * @author deatil
 */
class LakeadContent extends LakeadBase 
{
    /**
     * 列表
     */
    ...
    public function add() 
    {
        if (request()->isPost()) {
            $data = request()->post();
            $validate = $this->validate($data, '\\app\\lakead\\validate\\Content.add');
            if (true !== $validate) {
    ...
    public function edit() 
    {
        if (request()->isPost()) {
            $data = request()->post();
            $validate = $this->validate($data, '\\app\\lakead\\validate\\Content.edit');
            if (true !== $validate) {
                return $this->error($validate);
            }
            ...
            unset($data['image'], $data['url'], $data['code'], $data['name']);
